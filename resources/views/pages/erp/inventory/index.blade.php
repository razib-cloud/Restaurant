                            ...
                            <table class="table table-striped table-hover mb-0">
                                ...
                                <tbody>
                                    @forelse ($inventorys as $inventory)
                                        <tr>
                                            <td>{{ $inventory->id }}</td>
                                            <td>{{ $inventory->product ? $inventory->product->name : 'No Product' }}</td>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <a class="btn btn-sm btn-outline-secondary"
                                                        href="{{ route('inventorys.show', $inventory->id) }}">
                                                        <i class="fas fa-eye"></i> View
                                                    </a>
                                                    <a class="btn btn-sm btn-outline-success"
                                                        href="{{ route('inventorys.edit', $inventory->id) }}">
                                                        <i class="fas fa-edit"></i> Edit
                                                    </a>
                                                    <form method="POST"
                                                        action="{{ route('inventorys.destroy', $inventory->id) }}"
