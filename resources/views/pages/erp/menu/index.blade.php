        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body p-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a class="btn btn-sm btn-outline-secondary" href="{{ route('menus.edit', $menu->id) }}">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <a class="btn btn-sm btn-outline-primary" href="{{ route('menus.show', $menu->id) }}">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    ...
                    <div>
                        {{ $menus->appends(['perPage' => request('perPage')])->links('vendor.pagination.bootstrap-5') }}
                    </div>
                </div>
            </div>
        </div>
