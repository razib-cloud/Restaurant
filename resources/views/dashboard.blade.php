                        ...
                        <div class="col-xl-12">
                            <div class="card customer-wrapper">
                                ...
                                <div class="card-footer border-0 down-arrow pb-0">
                                    <a href="javascript:void(0);" class="dz-load-more fas fa-chevron-down" id="CustomerList" rel="{{ asset('assets') }}/ajax/customer-list.html" ></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                ...
                                <div class="card-footer border-0 down-arrow pb-0">
                                    <a href="javascript:void(0);" class="dz-load-more fas fa-chevron-down" id="DelieveryList" rel="{{ asset('assets') }}/ajax/delevery.html" ></a>
                                </div>
                            </div>
                        </div>
                    </div>
