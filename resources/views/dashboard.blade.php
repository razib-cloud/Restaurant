                        ...
                        <div class="card">
                            ...
                            <div class="card-body pb-0">
                                <div class="d-flex pb-3 mb-3 tr-row align-items-center border-bottom">
                                    ...
                                    <div class="me-auto pe-3">
                                        <a href="ecom-product-grid.html">
                                            <h2 class="text-black fs-14 font-w600">Medium Spicy Spagethi Italiano</h2>
                                        </a>
                                        <span class="text-black font-w600 d-inline-block me-3">$5.6 </span> <span
                                            class="fs-14">Order 89x</span>
                                    </div>
                                ...
                                <div class="d-flex pb-3 mb-3 tr-row align-items-center border-bottom">
                                    ...
                                    <div class="me-auto pe-3">
                                        <a href="ecom-product-grid.html">
                                            <h2 class="text-black fs-14 font-w600">Watermelon juice with ice</h2>
                                        </a>
                                        <span class="text-black font-w600 d-inline-block me-3">$5.6 </span> <span
                                            class="fs-14">Order 89x</span>
                                    </div>
                                ...
                                <div class="d-flex pb-3 mb-3 tr-row align-items-center border-bottom">
                                    ...
                                    <div class="me-auto pe-3">
                                        <a href="ecom-product-grid.html">
                                            <h2 class="text-black fs-14 font-w600">Chicken curry special with cucumber</h2>
                                        </a>
                                        <span class="text-black font-w600 d-inline-block me-3">$5.6 </span> <span
                                            class="fs-14">Order 89x</span>
                                    </div>
                                ...
                                <div class="d-flex pb-3 mb-3 tr-row align-items-center border-bottom">
                                    ...
                                    <div class="me-auto pe-3">
                                        <a href="ecom-product-grid.html">
                                            <h2 class="text-black fs-14 font-w600">Italiano Pizza With Garlic</h2>
                                        </a>
                                        <span class="text-black font-w600 d-inline-block me-3">$5.6 </span> <span
                                            class="fs-14">Order 89x</span>
                                    </div>
                                ...
                                <div class="d-flex pb-3 mb-3 tr-row align-items-center border-bottom">
                                    ...
                                    <div class="me-auto pe-3">
                                        <a href="ecom-product-grid.html">
                                            <h2 class="text-black fs-14 font-w600">Tuna Soup spinach with himalaya salt
                                            </h2>
                                        </a>
                                        <span class="text-black font-w600 d-inline-block me-3">$5.6 </span> <span
                                            class="fs-14">Order 89x</span>
                                    ...
                                    <div class="card-body height400 loadmore-content dz-scroll pb-0 pt-0"
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            <div class="recent-customer me-3">
                                                <img src="{{ asset('assets') }}/images/contacts/c1.jpg" width="50"
                                                    alt="">
                                            </div>
                                            <div>
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            <div class="recent-customer me-3">
                                                <img src="{{ asset('assets') }}/images/contacts/c2.jpg" width="50"
                                                    alt="">
                                            </div>
                                            <div>
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            <div class="recent-customer me-3">
                                                <img src="{{ asset('assets') }}/images/contacts/c3.jpg" width="50"
                                                    alt="">
                                            </div>
                                            <div>
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            <div class="recent-customer me-3">
                                                <img src="{{ asset('assets') }}/images/contacts/c4.jpg" width="50"
                                                    alt="">
                                            </div>
                                            <div>
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            <div class="recent-customer me-3">
                                                <img src="{{ asset('assets') }}/images/contacts/c5.jpg" width="50"
                                                    alt="">
                                            </div>
                                            <div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="recent-customer me-3">
                                                <img src="{{ asset('assets') }}/images/contacts/c6.jpg" width="50"
                                                    alt="">
                                            </div>
                                            <div>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card">
                                        ...
                                        <div class="loadmore-content dz-scroll" id="DelieveryListContent">
                                            <div class="d-sm-flex d-block border-bottom align-items-center mb-2">
                                                <div class="delivery-customer me-auto mb-2">
                                                    <img src="{{ asset('assets') }}/images/contacts/c33.jpg"
                                                        alt="">
                                                    <div>
                                                        <span class="font-w600 text-black fs-16">John Kusnaidi <span
                                                                class="text-primary">(4 Items)</span></span>
                                                        <span class="d-block fs-12 font-w600">Will be shipping on 11 : 24
                                                            AM</span>
                                                    </div>
                                                </div>
                                                <div
                                            ...
                                            <div class="d-sm-flex d-block border-bottom align-items-center mb-2">
                                                <div class="delivery-customer me-auto mb-2">
                                                    <img src="{{ asset('assets') }}/images/contacts/c11.jpg"
                                                        alt="">
                                                    <div>
                                                        <span class="font-w600 text-black fs-16">Margaretha <span
                                                                class="text-primary">(2 Items)</span></span>
                                                        <span class="d-block fs-12 font-w600">Will be shipping on 11 : 24
                                                            AM</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-sm-flex d-block border-bottom align-items-center mb-2">
                                                <div class="delivery-customer me-auto mb-2">
                                                    <img src="{{ asset('assets') }}/images/contacts/c22.jpg"
                                                        alt="">
                                                    <div>
                                                ...
                                                <div
                                                    class="d-flex align-items-center justify-content-end text-end location mb-2">
                                                    <div>
                                                        <span class="d-block f-s14 font-w400 text-black">Bossman St. 21444
                                                            ABC</span>
                                                        <span class="text-end f-s14 font-w400 text-black">United
                                                            Kingdom</span>
                                                    </div>
                                    ...
                                    <div class="card-footer border-0 down-arrow pb-0">
                                        <a href="javascript:void(0);" class="dz-load-more fas fa-chevron-down"
                                            id="DelieveryList" rel="ajax/delevery.html"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
