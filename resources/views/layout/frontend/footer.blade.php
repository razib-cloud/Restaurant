<div class="float-left w-100 position-relative footer-con main-box">
    <figure><img src="{{asset('frontassets')}}/images/footer-vector.png" alt="vector" class="position-absolute vector"></figure>
    <div class="container">
        <div class="row">
        ...
        <div class="float-left w-100 copyright-con d-flex align-items-center main-box">
            ...
            <div class="social-icons-con d-flex">
                ...
                <ul class="list-unstyled p-0 d-flex align-items-center mb-0">
                    ...
                    <li><a href="https://www.pinterest.com/" class="mr-0"><i class="fa-brands fa-pinterest"></i></a>
                    </li>
                    <li><a href="https://www.instagram.com/" class="mr-0"><i class="fa-brands fa-instagram"></i></a>
                    </li>
                </ul>
                <!-- social icons con -->
            </div>
